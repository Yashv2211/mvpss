      ...
      <div className="space-y-8 overflow-y-scroll custom-scrollbar max-h-[calc(100vh-220px)]">
        <div>
          ...
          <div className="space-y-1 pr-2">
            ...
            >
             <LessonItem
                title="Poem Recitation Coach"
                type="podcast"
                onClick={() => navigate("/content/activities/recite")}
                isSelected={selectedLesson === "Introduction to design fundamentals"}
              />
             <LessonItem
                title="Speech Recitation Coach"
                type="podcast"
                onClick={() => navigate("/content/activities/recitespeech")}
                isSelected={selectedLesson === "Introduction to design fundamentals"}
              />
            </ModuleItem>
            <ModuleItem
            ...
            >
              <LessonItem
                title="French"
                type="podcast"
                onClick={() => navigate("/content/activities/french")}
              />
              <LessonItem
                title="Spanish"
                type="podcast"
                onClick={() => navigate("/content/activities/spanish")}
              />
            </ModuleItem>
            <ModuleItem
              title="Debate Coach"
            ...
            >
              <LessonItem
                title="Debate AI"
                type="podcast"
                onClick={() => navigate("/content/activities/debate")}
              />
            </ModuleItem>
            <ModuleItem

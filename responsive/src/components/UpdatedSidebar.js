    ...
    <>
      ...
      {isMobile && (
        <button
          ...
          className="fixed top-1b left-1 z-50 p-2 bg-white text-black rounded-md"
        >
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 h-[calc(100vh-1px)] w-full sm:w-[320px] z-[2] bg-black border-r border-gray-800 p-6 transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="space-y-8 overflow-y-scroll custom-scrollbar max-h-[calc(100vh-310px)] sm:max-h-[calc(100vh-220px)]">
          <div>
            ...
            <div className="space-y-1 pr-2">
              ...
              >
                <LessonItem
                  ...
                  type="podcast"
                  onClick={() => {navigate("/content/ai"); toggleSidebar()}}
                ...
                <LessonItem
                  ...
                  duration="21:46"
                  type="story"
                  onClick={() => {navigate("/content/youtube"); toggleSidebar()}}
                ...
                <LessonItem
                  ...
                  duration="2:02"
                  type="video"
                  onClick={() => {navigate("/content/youtube2"); toggleSidebar()}}
                ...
                <LessonItem
                  ...
                  duration="3:56"
                  type="video"
                  onClick={() => {navigate("/content/youtube3"); toggleSidebar()}}
                  isSelected={selectedLesson === "Psychology in design fundamentals"}
                />
              </ModuleItem>
              {/* Add other ModuleItems here */}
            </div>
          </div>
          <div>
            <h2 className="mb-3 px-2 text-sm font-medium text-gray-400 uppercase tracking-wider">
